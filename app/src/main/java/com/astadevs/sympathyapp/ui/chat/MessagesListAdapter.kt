...
import com.astadevs.sympathyapp.databinding.ListItemMessageReceivedBinding
import com.astadevs.sympathyapp.databinding.ListItemMessageSentBinding

class MessagesListAdapter internal constructor(private val viewModel: ChatViewModel, private val userId: String) : ListAdapter<Message, RecyclerView.ViewHolder>(
    MessageDiffCallback()
) {
